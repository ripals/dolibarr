...
/**
 *	\file       htdocs/core/modules/supplier_order/pdf/pdf_pmlogic.modules.php
 *	\ingroup    fournisseur
 ...
 */
class pdf_pmlogic extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "PMLogic";
		$this->description = $langs->trans('PM Logic Order Template');
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0, $currency='')
	{
        ...
        if (empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT))
        {
			...
			if (empty($hidetop))
			{
    			...
    			$pdf->MultiCell($this->posxlocaltax1-$this->posxtva+3,2, $outputlangs->transnoentities("VAT"),'','C');
			}
